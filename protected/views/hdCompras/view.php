...
Yii::app()->clientScript->registerScript('emptymodal', "
...
<div class="row text-center contact-info">
     <div class="col-lg-12 col-md-12 col-sm-12">
         ...
         <span>
             <strong>Proveedor : </strong><?php echo $model->iDPROVEEDOR->NOMBRE; ?>
         </span>
          <span>
...
<div class="row">
    ...
    'afterDelete'=>'function(link,success,data){ if(success) $.notify("Eliminado", "success");}',
    'header' => 'Acciones',
    'htmlOptions' => array(
...
<div class="modal-body">
    <?php $this->renderPartial('../dtcompras/_addArticulo',array(
        'model'=>$modeldt,
    )); ?>
</div>
<?php $this->endWidget();?>